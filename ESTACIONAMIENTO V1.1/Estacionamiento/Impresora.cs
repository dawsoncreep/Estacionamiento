...
namespace Estacionamiento
{
   #region Clase para generar ticket
    ...
    public class CreaTicket
    {
        ...
        //string impresora = "\\\\localhost\\Generic"; // nombre exacto de la impresora como esta en el panel de control
        string impresora = "Generic"; // nombre exacto de la impresora como esta en el panel de control
        int max, cort;
        ...
        public void mandarImagen(Byte[] img)
        {
         //   RawPrinterHelper.SendBytesToPrinter(impresora, img, 0);
