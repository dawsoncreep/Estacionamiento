...
namespace Estacionamiento
{
    public partial class f_Inicio : Form
    {
        ...
        private static decimal tolerancia, costoHora, costoDia, costoMes, boletoPerdido;
        ...
        private void cargarDatos()
        {
            ...
            {
                MessageBox.Show("Debe llenar los datos de parametros para iniciar","Error" );
                f_parametros parame = new f_parametros();
                parame.ShowDialog();
            }
        }
        /// <summary>
        ...
        private void b_CrearRegistro_Click(object sender, EventArgs e)
        {
            ...
            tick.AddFooterLine("Boleto Perdido $" + boletoPerdido);
            tick.AddFooterLine(leyenda);
            try
            {
                tick.PrintTicket("Generic");
            }
            catch { MessageBox.Show("Error al imprimir"); }
        ...
        private void hacerCobro()
        {
            ...
            minCobrar += horaCobrar * 60;


            minCobrar -= int.Parse(tolerancia.ToString());

            //if (minCobrar < tolerancia)
            //{
            //    horaCobrar--;
        ...
        private void cb_boletoPerdido_CheckedChanged(object sender, EventArgs e)
        {
            if (cb_boletoPerdido.Checked)
            {
                ...
                t_total.Text = boletoPerdido.ToString();
                calcular();
                MessageBox.Show("BOLETO PERDIDO $" + boletoPerdido, "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void b_reimprimir_Click(object sender, EventArgs e)
        {
